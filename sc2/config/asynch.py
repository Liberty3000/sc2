...
flags.DEFINE_string (              'agent', default='sc2.agents.a3c.A3C', help='')
flags.DEFINE_string (         'controller', default='sc2.controllers.recurrent_ac.fused_lstm.FusedLSTM', help='')
flags.DEFINE_integer(            'workers', default=3, help='')

flags.DEFINE_bool   (              'train', default=True, help='')
flags.DEFINE_integer(              'bsize', default=64, help='')

flags.DEFINE_string (                'map', default='FindAndDefeatZerglings', help='')
